...
public class Runner
{
    ...
    public static void main(String[] args)
    {
        ...
        // List<String> command = Arrays.asList("/Users/kyrilosvourlakidis/tmp/moomin");
        List<String> command = Arrays.asList("moomin");
        // List<String> command = Arrays.asList("env");
        File runFrom = new File("/Users/kyrilosvourlakidis");
        runCommand(command, null, runFrom);

    }

    private static int runCommand(List<String> commandWithArgs, List<String> environmentAssignments, File directoryToRunFrom, boolean print)
    {
    ...
    private static int runCommand(List<String> commandWithArgs, List<String> environmentAssignments, File directoryToRunFrom)
    {
